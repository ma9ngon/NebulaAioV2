...
namespace NebulaAio.Champions
{
    ...
    public class Ezreal
    {
        ...
        private static void LogicR()
        {
            ...
            if (R.IsReady() && useR.Enabled && input.Hitchance >= hitchance && !ObjectManager.Player.InAutoAttackRange(target) && ObjectManager.Player.GetSpellDamage(target, SpellSlot.R) > target.Health && target.IsValidTarget(Config["Misc"].GetValue<MenuSlider>("Rrange").Value))
            {
